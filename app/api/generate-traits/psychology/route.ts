...
const CATEGORY_LABEL = "Psychology";
const CATEGORY_GUIDANCE =
  "Emotions, motivations, thoughts, beliefs, mental state.";
...
Return JSON that matches the provided schema.`;
    ...
    console.error("Error brainstorming psychology traits:", error);
    return NextResponse.json(
      { error: "Unable to brainstorm psychology traits" },
      { status: 500 },
    );
  }
}
